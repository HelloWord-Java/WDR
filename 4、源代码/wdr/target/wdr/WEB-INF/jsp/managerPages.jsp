        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li data-id="userManager">
                        <a href="#" class="text-center">
                            <i class="${menu.icon } fa-fw"></i> 用户管理
                        </a>
                    </li>
                    <li data-id="weddingDressManager">
                        <a href="#" class="text-center">
                            <i class="${menu.icon } fa-fw"></i> 婚纱管理
                        </a>
                    </li>
                    <li data-id="orderFormManager">
                        <a href="#" class="text-center">
                            <i class="${menu.icon } fa-fw"></i> 订单管理
                        </a>
                    </li>
                    <li>
