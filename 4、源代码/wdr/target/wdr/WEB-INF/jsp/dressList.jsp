...
<div class="row">
    <div class="col-md-12 column">
        <div class="tabbable" id="tabs-484507">
            <ul class="nav nav-tabs page-header">
                <li class="active">
                    <a href="#panel-857700" data-toggle="tab">公主型</a>
                </li>
                <li>
                    <a href="#panel-440044" data-toggle="tab">蓬裙型</a>
                </li>
                <li>
                    <a href="#panel-66066" data-toggle="tab">贴身型</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="panel-857700">
                    <div class="row">
                        <c:forEach items="${weddingDressList1}" var="l" begin="0" end="7">
                ...
                <div class="tab-pane" id="panel-440044">
                    <div class="row">
                        <c:forEach items="${weddingDressList2}" var="l" begin="0" end="7">
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    <img src="${pageContext.request.contextPath}upload/photo${l.weddingdressId}.jpg"
                                         alt="未找到图片！">
                ...
                <div class="tab-pane" id="panel-66066">
                    <div class="row">
                        <c:forEach items="${weddingDressList3}" var="l" begin="0" end="7">
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    <img src="${pageContext.request.contextPath}upload/photo${l.weddingdressId}.jpg"
                                         alt="未找到图片！">
